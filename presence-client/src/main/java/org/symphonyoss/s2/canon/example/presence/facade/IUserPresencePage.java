...
import org.symphonyoss.s2.canon.example.presence.canon.IUserPresencePageModelObject;

/**
 * Facade for Object Object(UserPresencePage)
 */
@Immutable
public interface IUserPresencePage extends IUserPresencePageModelObject
{
}
/*----------------------------------------------------------------------------------------------------
